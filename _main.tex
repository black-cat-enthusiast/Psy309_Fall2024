...
\urlstyle{same}
\hypersetup{
  pdftitle={A book of Practical Assignments for Psy309 at UTM Fall 2025},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{A book of Practical Assignments for Psy309 at UTM Fall 2025}
\author{}
\date{\vspace{-2.5em}}
...
\addcontentsline{toc}{section}{1. Experiments: Manipulating Independent Variable(s)}
...
\addcontentsline{toc}{section}{2. Proposed Magnitude of the effect of your IV on the DV}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# this is the "setup" chunk. Info here will apply to all code blocks in the document. }
\NormalTok{knitr}\SpecialCharTok{::}\NormalTok{opts\_chunk}\SpecialCharTok{$}\FunctionTok{set}\NormalTok{(}\AttributeTok{echo =} \ConstantTok{TRUE}\NormalTok{, }\CommentTok{\# Show the code}
                      \AttributeTok{warning =} \ConstantTok{FALSE}\NormalTok{, }\CommentTok{\# Hide warnings from R}
                      \AttributeTok{message =} \ConstantTok{FALSE}\NormalTok{) }\CommentTok{\# Hide messages from R}
\end{Highlighting}
\end{Shaded}
...
\addcontentsline{toc}{section}{1. Connecting covariates to you dependent variable of interest}
...
\addcontentsline{toc}{section}{4. A picture is worth 1000 words\ldots{}}
...
\CommentTok{\# You only need to install once per computer. }

\CommentTok{\# install.packages(c("faux","tidyverse","pwr")) \# Remove leading hashtag to run this line! }
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{pwr.r.test}\NormalTok{(}
  \AttributeTok{n =} \ConstantTok{NULL}\NormalTok{,}
  \AttributeTok{r =} \SpecialCharTok{{-}}\FloatTok{0.3}\NormalTok{,}
...
Make sure to \textbf{\emph{always}} round up the number of participants!

\begin{itemize}
\tightlist
\item
  My analysis indicates that a sample size of \(n = 85\) would be required to detect statistical significance at \(\alpha = 0.05\) for a relationship where \(r = 0.3\).
\end{itemize}
...
\addcontentsline{toc}{subsection}{Compute a simple linear regression}
...
\begin{figure}
\includegraphics[width=16.67in]{JLB_graph} \caption{ADD A FIGURE CAPTION HERE}\label{fig:unnamed-chunk-17}
\end{figure}
...
\begin{figure}
\includegraphics[width=12.5in]{2_bars} \caption{First example: Here, I divided the continuous covariate into two categories.}\label{fig:unnamed-chunk-21}
\end{figure}
...
\begin{figure}
\includegraphics[width=25in]{graph_2} \caption{Side-by-side comparisons of continuous relationships at each level of the moderator.}\label{fig:unnamed-chunk-34}
\end{figure}
...
\begin{figure}
\includegraphics[width=16.67in]{graph_3} \caption{Overlapping lines show the different linear relationships for the two levels of the moderator variable.}\label{fig:unnamed-chunk-35}
\end{figure}
...
\tightlist
\item
  Each TA marks 8 - 10 submissions across all five practical assignments
\item
  Practicals are intended to be ``bite-sized'' pieces of their final paper project.
\item
  Each submission will be graded out of \textasciitilde15 marks.
\item
...
\tightlist
\item
  ``Capstone'' project for this course (8-10 pages all-in)
\item
  You will evaluate \textasciitilde11 students' assignments.
\item
...
\item
  In any situation where students are hostile or you don't know how to respond to them, feel free to forward their correspondences along to me to deal with. \emph{You can count on me to back you up!} :)
\end{itemize}
...
\hline
Practical 1 & 2025-09-11 & Online & Small\\
\hline
Practical 2 & 2025-09-26 & Online & Small\\
\hline
Test \#1 & 2025-10-02 & Online & Med\\
\hline
Practical 3 & 2025-10-10 & Online & Small\\
\hline
Practical 4 & 2025-10-24 & Online & Small\\
\hline
Practical 5 & 2025-11-07 & Online & Small\\
\hline
Poster & 2025-11-20 & Online & Small\\
\hline
Test \#2 & 2025-11-27 & Online & Med\\
\hline
Paper & 2025-12-01 & Online & Largest\\
\hline
\end{tabular}

...
## 1. Connecting covariates to your topic of interest {-}
...
## 2. Experiments: Manipulating Independent Variable(s) {-}
...
ggsave("Figs/hist_1.png",histogram,height = 3, width = 5, dpi = 300)
...
# Save the histogram as a high quality .png image
ggsave("Figs/hist_2.png",histogram,height = 3, width = 5, dpi = 300)

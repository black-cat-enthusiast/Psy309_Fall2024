...
# Practical Assignment #4: Exploring Variability in the DV
...
- The code above assigns a dataframe with two columns onto the object `data`. 

- The first column will have a mean of 65 and a standard deviation of 10. This column represents the age of the participants in my fictitious study. 
...
- By default, the `rnorm_multi()` function names the columns X1 and X2 (not the most informative!)
...
- The actual correlation between my two columns of data is -.27. 
...
- The Estimate for my predictor (Age) is the slope of the line of best fit. 
...
- I also added `theme_classic()` which makes the chart appear more academic than the default ggplot output. 